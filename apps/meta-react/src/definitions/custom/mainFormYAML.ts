export const mainFormDefinitionYAML = `
...
items:
  - name: container
    renderer: container
    ui:
      label: Primitive elements and behaviors in container
    items:
      - name: container-primitives1
        binding: c1
        renderer: textbox
        ui:
          label: >-
            String field (enter here and see result in label3 as both bound to
            same data path)
      - name: container-primitives2
        binding: c2
        renderer: textbox
        ui:
          label: Number field
        type: number
      - name: container-primitives3
        binding: c3
        renderer: textbox
        ui:
          label: Boolean field
        type: bool
      - name: container-primitives4
        binding: c1
        renderer: label
        ui:
